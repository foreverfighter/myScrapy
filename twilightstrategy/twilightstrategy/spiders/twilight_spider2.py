...
#     default_output_processor = TakeFirst()
    ...
    # time_in = MapCompose(unicode.strip)
    # side_in = MapCompose(unicode.strip)
    # ops_in = MapCompose(unicode.strip)
    # removed_in = MapCompose(unicode.strip)
...
class TwilightSpider(scrapy.Spider):
    ...
    def parse_card(self, response):
        ...
        l = ItemLoader(item=TwilightstrategyItem(), response=response)
